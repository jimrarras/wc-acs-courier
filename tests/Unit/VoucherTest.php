...
class VoucherTest extends TestCase {
    ...
    public function test_auto_create_skips_an_order_shipped_with_boxnow(): void {
        // A store running wc-boxnow-delivery alongside this plugin: a BOX NOW
        // locker order reaching the trigger status must not also get an ACS
        // voucher. The ACS rate may be a plain flat_rate, so the rule is
